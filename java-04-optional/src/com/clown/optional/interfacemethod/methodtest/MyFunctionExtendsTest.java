...
import com.clown.optional.interfacemethod.impl.MyClassExtends;
 ...
 *
 **/
public class MyFunctionExtendsTest {

    public static void main(String[] args){

        MyClassExtends myClass = new MyClassExtends();
        System.out.println(myClass.listen());
    }
}
