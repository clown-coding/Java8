...
import com.clown.optional.interfacemethod.impl.MyFunctionImpl;
 ...
 *
 **/
public class MyFunctionImplTest {

    public static void main(String[] args){
        MyFunctionImpl function = new MyFunctionImpl();
        System.out.println(function.listen());
